...
class TriviaGameStaticSitePipeline extends cdk.Stack {
    constructor(parent: cdk.App, name: string, props?: cdk.StackProps) {
        ...
        this.addBuildAction(testStage, 'Test', 'test', 'test.dunkelfrosch.cloud', source.outputArtifact);

        // Prod
        const prodStage = pipeline.addStage('Prod');
        this.addBuildAction(prodStage, 'Prod', 'prod', 'trivia.dunkelfrosch.cloud', source.outputArtifact);
    }
