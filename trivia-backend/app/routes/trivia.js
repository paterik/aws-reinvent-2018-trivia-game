 ...
 *     curl -i https://api.dunkelfrosch.cloud/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.dunkelfrosch.cloud/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.dunkelfrosch.cloud/api/trivia/question/1
 */
